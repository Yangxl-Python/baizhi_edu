<template>
  <div class="cart">
    <div class="cart-info">
      ...
      <div class="cart-item" v-for="course in course_list" :key="course.id">
        <el-row>
          <el-col :span="2" class="checkbox">&nbsp;&nbsp;</el-col>
          <el-col :span="10" class="course-info">
            <img :src="course.course_img" alt=商品图片>
      ...
      <div class="calc">
        <el-row class="pay-row">
          ...
          <el-col :span="4" class="cart-pay"><span @click="submit_order">提交订单</span></el-col>
        </el-row>
      </div>
    </div>
  </div>
  ...
  export default {
    ...
    methods: {
      ...
      get_select_course() {
        ...
        this.$axios({
          url: `${this.$settings.HOST}cart/order/`,
          method: 'get',
          headers: {
