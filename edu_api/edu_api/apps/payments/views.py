...
from edu_api.settings.develop import ALIAPY_CONFIG
from order.models import Order
from payments.models import UserCourse

# 公私钥的位置 # 自己生成的私钥
app_private_key_string = ALIAPY_CONFIG.get('app_private_key_path')
# 支付宝的公钥
alipay_public_key_string = ALIAPY_CONFIG.get('alipay_public_key_path')
# 初始化支付参数
alipay = AliPay(
...
class AliPayResultAPIView(APIView):
    ...
    def get(self, request):
        # 验证alipay的异步通知，data来自支付宝回调POST给你的data，字典格式.
            ...
            try:
                ...
                for order_detail in order_detail_list:
                    ...
                    if order_detail.expire > 0:
                        expire_timestamp = order_detail.expire * 24 * 60 * 60
                        # 当前购买时间 + 有效期时间 = 最终到期时间
